...
#
# Generated by Vivado on Wed Dec 15 23:39:45 +0800 2021
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hw.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../hw.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../hw.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
